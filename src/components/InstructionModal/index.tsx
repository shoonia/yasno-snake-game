...
const close: JSX.EventListener<HTMLDialogElement> = (event) => {
...
export const InstructionModal: JSX.FC = () =>
  ...
  >
    <div class={s.content}>
      ...
      <p>
        <strong>З мобілочки:</strong> по суті сейм, але замість стрілочок свайпай пальчиком в необхідний момент в необхідному напрямку.
      </p>
